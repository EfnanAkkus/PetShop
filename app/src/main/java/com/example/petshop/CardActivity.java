    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Card, CardViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CardViewHolder holder, int position, @NonNull final Card model) {
              ...
              // int oneTyprProductPrice = (Integer.parseInt(model.getPrice().replaceAll("\\D+", ""))) * Integer.parseInt(model.getQuantity());
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(CardActivity.this, "Item removed successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        txtMsg1.setText("Congratulations, your final order has been Shipped successfuly. Soon you will received your order at your door step");
                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CardActivity.this, "You can purchase more product once you received your first final order", Toast.LENGTH_SHORT).show();
