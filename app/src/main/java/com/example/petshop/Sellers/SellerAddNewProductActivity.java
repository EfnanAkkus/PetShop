...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private String sName, sAddresss, sPhone, sEmail, sID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Products");//product ları veritabanına kaydetmek için kullanıyoruz
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            sAddresss = dataSnapshot.child("address").getValue().toString();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                        ...
                        downloadImageUrl = filePath.getDownloadUrl().toString();//image url ini burada saklıyoruz
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("sellerAddress", sAddresss);
        productMap.put("sellerEmail", sEmail);
        productMap.put("sid", sID);
        productMap.put("productState", "Not Approved");

        ProductsRef.child(productRandomKey).updateChildren(productMap)//random olmasının sebebi her ürün kendi id sine sahiptir
